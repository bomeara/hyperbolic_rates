...
uyeda <- subset(hyperr8_analysis, dataset=="Uyeda et al. (2011)" & model=="hmb" & rep %in% c("Original", "Rep 1", "Rep 2"))
uyeda$dataset <- "Body size"

create_lenticular_plot_uyeda <- function(uyeda) {
	uyeda_data <- get_uyeda_data()
	uyeda_data$Species1 <- NA
	uyeda_data$Species2 <- NA
	for (i in sequence(nrow(uyeda_data))) {
	...
	g <- ggplot(short, aes(x=time, y=empirical_rate, colour=hyperbolic_component_proportion)) + geom_point(data=~subset(.x, rep_number==0, -rep_number),  size=0.2, colour="lightgray") + geom_line(data=~subset(.x, rep_number==0, -rep_number), aes(y=predicted_rate), colour="lightgray") + geom_point(data=subset(short, rep_number==0), aes(group=unique_numerator), size=0.2, colour="black", alpha=0.5) + geom_image(data=subset(short, rep_number==0), aes(group=unique_numerator, image=img), colour="red", size=subset(short, rep_number==0)$img_size) + facet_wrap(~dataset, scales="free") + theme_bw() + theme(legend.position="none") + xlab("h") + ylab("m") + scale_x_continuous(trans="log") +  labs(title = 'Original', x = 'Time', y = 'Rate') + geom_line(data=subset(short, rep_number==1), aes(y=predicted_rate), colour="purple") + scale_x_continuous(trans="log10", breaks=chosen_breaks, labels=c("1", "1K", "100K", "1M", "10M", "100M")) + scale_y_continuous(trans="log10", breaks=c(10, 1e6, 1e12)) + theme(text=element_text(size=20))
	ggsave(filename="body_size_original.tiff", plot=g, width=10, height=8, units="in", dpi=300, compression = "lzw")
	
	g <- ggplot(short, aes(x=time, y=empirical_rate, colour=hyperbolic_component_proportion)) + geom_point(data=~subset(.x, rep_number==0, -rep_number),  size=0.2, colour="lightgray") + geom_line(data=~subset(.x, rep_number==0, -rep_number), aes(y=predicted_rate), colour="lightgray") + geom_point(data=subset(short, rep_number==1), aes(group=unique_numerator), size=0.2, colour="black", alpha=0.5) + geom_image(data=subset(short, rep_number==1), aes(group=unique_numerator, image=img), colour="red", size=subset(short, rep_number==1)$img_size) + facet_wrap(~dataset, scales="free") + theme_bw() + theme(legend.position="none") + xlab("h") + ylab("m") + scale_x_continuous(trans="log") +  labs(title = 'Rep 1', x = 'Time', y = 'Rate') + geom_line(data=subset(short, rep_number==1), aes(y=predicted_rate), colour="purple") + scale_x_continuous(trans="log10", breaks=chosen_breaks, labels=c("1", "1K", "100K", "1M", "10M", "100M")) + scale_y_continuous(trans="log10", breaks=c(10, 1e6, 1e12)) + theme(text=element_text(size=20))
	ggsave(filename="body_size_rep1.tiff", plot=g, width=10, height=8, units="in", dpi=300, compression = "lzw")


	g <- ggplot(short, aes(x=time, y=empirical_rate, colour=hyperbolic_component_proportion)) + geom_point(data=~subset(.x, rep_number==0, -rep_number),  size=0.2, colour="lightgray") + geom_line(data=~subset(.x, rep_number==0, -rep_number), aes(y=predicted_rate), colour="lightgray") + geom_point(data=subset(short, rep_number==2), aes(group=unique_numerator), size=0.2, colour="black", alpha=0.5) + geom_image(data=subset(short, rep_number==2), aes(group=unique_numerator, image=img), colour="red", size=subset(short, rep_number==2)$img_size) + facet_wrap(~dataset, scales="free") + theme_bw() + theme(legend.position="none") + xlab("h") + ylab("m") + scale_x_continuous(trans="log") +  labs(title = 'Rep 2', x = 'Time', y = 'Rate') + geom_line(data=subset(short, rep_number==2), aes(y=predicted_rate), colour="purple") + scale_x_continuous(trans="log10", breaks=chosen_breaks, labels=c("1", "1K", "100K", "1M", "10M", "100M")) + scale_y_continuous(trans="log10", breaks=c(10, 1e6, 1e12)) + theme(text=element_text(size=20))
	ggsave(filename="body_size_rep2.tiff", plot=g, width=10, height=8, units="in", dpi=300, compression = "lzw")
...
create_lenticular_plot_uyeda(uyeda)
```
